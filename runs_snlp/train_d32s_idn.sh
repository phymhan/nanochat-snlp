#!/bin/bash
# Train: Nanochat-0.5B IDN reg (d32s, x0+VE, lambda=0.0625, stride=3, no-detach)
# Model tag: d32s_idn00625_npar24_s3, 4800 steps
set -e
...
PYTHONUNBUFFERED=1 torchrun --standalone --nproc_per_node=${NGPU:-4} \
    ...
    --run=dummy \
    2>&1 | tee "$NANOCHAT_BASE_DIR/d32s_idn00625_npar24_s3_train.log"
